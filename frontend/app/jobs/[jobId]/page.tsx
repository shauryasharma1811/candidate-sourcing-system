...
function JobDetailSkeleton() {
  return (
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
      ...
      <div className="h-56 animate-pulse rounded-lg bg-gray-200 lg:col-span-1" />
    </div>
  );
}
    ...
    <>
      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
        <div className="space-y-8 lg:col-span-2">
          <div className="rounded-lg bg-white p-6 shadow-sm ring-1 ring-gray-200 sm:p-8">
            <div className="flex flex-wrap items-start justify-between gap-3">
              <div>
                <h1 className="text-2xl font-semibold text-gray-900 sm:text-3xl">{job.title}</h1>
            ...
            <div className="mt-6 flex flex-col gap-3 border-t border-gray-200 pt-6 lg:hidden">
              <QuickFacts job={job} />
        ...
        <aside className="hidden lg:col-span-1 lg:block">
          <div className="sticky top-24 space-y-6 rounded-lg bg-white p-6 shadow-sm ring-1 ring-gray-200">
            <QuickFacts job={job} />
      ...
      <div className="fixed inset-x-0 bottom-0 z-40 flex gap-3 border-t border-gray-200 bg-white p-4 shadow-[0_-1px_4px_rgba(0,0,0,0.05)] lg:hidden">
        <Link href={`/jobs/${job.id}/apply`} className="flex-1">
          <Button type="button" className="w-full">
            Apply Now
          </Button>
        ...
        <div className="mt-6">
          ...
          {!isLoading && notFound && (
            <div className="rounded-lg bg-white p-8 text-center ring-1 ring-gray-200">
              <p className="text-gray-900">This job posting isn&apos;t available.</p>
              <p className="mt-1 text-sm text-gray-500">It may have closed or the link may be incorrect.</p>
            </div>
          )}
